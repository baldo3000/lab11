...
public final class LambdaFilter extends JFrame {
  ...
  private enum Command {
    ...
    TO_LOW("Convert to lowercase", String::toLowerCase),
    COUNT_CHARS("Count the number of chars", str -> String.valueOf(str.length())),
    COUNT_LINES("Count the number of lines", str -> String.valueOf(str.lines().count())),
    ORDER("List all the words in alphabetical order", str -> 
